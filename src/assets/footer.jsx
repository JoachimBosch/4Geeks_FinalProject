        ...
        <footer className="w-full py-10 bg-black">
            <div className="max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-[150px_auto] divide-x">
                    <div className="w-fit ">
                        <img src="/4GeeksAcademyLogo-500x474.jpg" className="max-w-16 mx-auto"></img>
                        <p className="text-orange-50 text-center text-lg">4Geeks Academy </p>
                    </div>
                    <div className="px-5 min-w-3/4">
                        <p className="text-orange-50 text-2xl font-semibold pb-2">Final Project</p>
