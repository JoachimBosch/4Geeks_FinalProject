...
const boxes = [
  {id: 1,
    ...
    item_4: "Pillow spray",
    item_1_text: "A compact ball that dissolves in bathwater, releasing fragrance, color, and skin-soothing ingredients.",
    item_2_text: "A candle infused with fragrances, used to create a calming ambiance when lit.",
    item_3_text: "Herbal tea made from chamomile flowers, known for its calming properties.",
    item_4_text: "A spray with soothing scents, applied to pillows to promote better sleep.",
  }, 
  {id: 2,
    name: "Revive",
    price: 49.00,
    ...
    item_1_text: "A skincare product applied to the face to cleanse, hydrate, or treat skin.",
    item_2_text: "Tea made from various herbs, often used for relaxation or health benefits.",
    item_3_text: "A small roller bottle containing essential oils for topical use to relieve stress or tension.",
    item_4_text: "A mist applied to the face or body to cool and refresh the skin.",
  },
  {id: 3,
    name: "Reconnect",
    price: 49.00,
    ...
    item_4: "Mint tea",
    item_1_text: "A set of cards with questions or prompts designed to spark meaningful conversations.",
    item_2_text: "A journal for writing daily reflections on things you're grateful for.",
    item_3_text: "A roller with soothing essential oils, applied to pulse points for relaxation.",
    item_4_text: "Tea infused with mint leaves, known for its refreshing and digestive benefits.",
  },
  {id: 4,
    name: "Recharge",
    price: 49.00,
    ...
    item_1_text: "A beverage designed to boost energy, often containing caffeine and other stimulants.",
    item_2_text: "A snack rich in protein, intended to support muscle repair and provide energy.",
    item_3_text: "A book that provides inspiration and encouragement for personal growth.",
    item_4_text: "Supplements that provide energy, often containing vitamins and minerals.",
  },
  {id: 5,
    name: "Refresh",
    price: 49.00,
    ...
    item_1_text: "A gel applied around the eyes to reduce puffiness and provide a cooling sensation.",
    item_2_text: "A cleansing product used in the shower, formulated to leave the skin feeling fresh and energized.",
    item_3_text: "A body cleanser with granules that remove dead skin cells for smoother skin.",
    item_4_text: "A cooling mist for the face, infused with mint for a refreshing effect.",
  },
  {id: 6,
    name: "Refocus",
    price: 49.00,
    ...
    item_3: "Journal",
    item_4: "Puzzle book",
    item_1_text: "A type of tea made from unoxidized leaves, known for its antioxidant properties.",
    item_2_text: "A set of cards with prompts or exercises to encourage mindfulness and meditation.",
    item_3_text: "A notebook used for writing personal thoughts, reflections, or plans.",
    item_4_text: "A book filled with puzzles like crosswords, sudoku, or riddles, for mental stimulation.",
  },
  {id: 7,
    name: "Rebalance",
    price: 49.00,
    ...
    item_4: "Green tea",
    item_1_text: "A resource (often a book or audio) providing instructions on meditation techniques.",
    item_2_text: "A skincare product that helps restore the skin's natural pH balance after cleansing.",
    item_3_text: "A fragranced candle used to create a peaceful atmosphere.",
    item_4_text: "Antioxidant-rich tea made from unoxidized leaves, offering various health benefits.",
  }
]
